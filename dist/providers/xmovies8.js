...
source.getResource = function (movieInfo, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    var url, parseSearch, links, parseDetail_1, linkServers_1, episodeId_1, arrMap;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = "https://xmovies8.si/movie/search/" + slugify(movieInfo.title, { lower: true, replacement: "+" });
                parseSearch = libs.request_getcaptcha(url, {});
                links = "";
                ...
                parseDetail_1 = libs.request_getcaptcha(link, {});
                linkServers_1 = [];
